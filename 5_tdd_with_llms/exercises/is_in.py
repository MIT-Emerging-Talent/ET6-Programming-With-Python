...
def is_in(thestring: str, list1: list, list2: list) -> bool:
    """Fuction that return True if the string is in at least one list
    Args:
    ...
    if thestring in list1 or thestring in list2:
        return True
    else:
        return False
